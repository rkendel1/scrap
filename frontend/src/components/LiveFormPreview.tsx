...
export const LiveFormPreview: React.FC<LiveFormPreviewProps> = ({
  ...
  // Removed previewContainerRef, formNaturalSizeRef, scale, and currentFormHeight states
  ...
  // Removed useEffect for scaling logic
  ...
  return (
    <div className="card live-preview-card">
      ...
      <div className="live-preview-content-wrapper">
        {/* Removed formNaturalSizeRef and its content */}

        {/* This div now directly contains the formContent without scaling */}
        <div
          style={{
            display: 'flex',
