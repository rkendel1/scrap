...
import { Palette, Type, Mic, Sparkles } from 'lucide-react';
...
export const WebsiteAnalysisSummary: React.FC<WebsiteAnalysisSummaryProps> = ({
  ...
  if (!hasAnalysisData) {
    return (
      <div className="card p-6 text-center flex flex-col items-center justify-center h-full">
  ...
  return (
    <div className="card p-6 space-y-4">
      <h3 className="text-lg font-semibold text-gray-800 text-center">Website Analysis Summary</h3>
