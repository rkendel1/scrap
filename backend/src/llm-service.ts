...
3. **Crucially, use the provided design tokens for the form's styling. Specifically, set 'primaryColor' to '${primaryColor}', 'backgroundColor' to '${backgroundColor}', 'fontFamily' to '${fontFamily}', and set 'maxWidth' to a reasonable value like '300px' or '75%' in the 'styling' object.**
    ...
    try {
      ...
      return {
        ...
        styling: {
          ...
          maxWidth: parsed.styling?.maxWidth || '300px' // Default to 300px if not provided
        },
        // Removed formLayout
      };
    } catch (error) {
      ...
      return {
        ...
        styling: {
          ...
          borderRadius: '8px',
          buttonStyle: 'solid',
          maxWidth: '300px' // Default to 300px for fallback
        },
  ...
  private generateMockForm(websiteData: any, formPurpose: string): GeneratedForm {
    ...
    return {
      ...
      styling: {
        ...
        borderRadius: '8px',
        buttonStyle: 'solid',
        maxWidth: '300px' // Default to 300px for mock
      },
